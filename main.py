...
def on_key_event(e):
    ...
    elif e.event_type == keyboard.KEY_DOWN and keyboard.is_pressed('ctrl') and keyboard.is_pressed('v') and keyboard.is_pressed('1'):
        pyperclip.copy(copied_texts.get('1', ''))
        keyboard.press_and_release('ctrl+v')

    elif e.event_type == keyboard.KEY_DOWN and keyboard.is_pressed('ctrl') and keyboard.is_pressed('v') and keyboard.is_pressed('2'):
